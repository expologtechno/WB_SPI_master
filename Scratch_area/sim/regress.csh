...
do
   ...
   do
	...
	make run_regress TEST_NAME="${test_name[$i]}" SIM_OPTS="${sim_opts[$i]} -sv_seed $SEED_VALUE -l ${test_name[$i]}_$SEED_VALUE.log +UVM_TIMEOUT=100000000 +UVM_MAX_QUIT_COUNT=100 -do "coverage save -onexit ${test_name[$i]}_$SEED_VALUE.ucdb;run -all; exit"" >/dev/null
